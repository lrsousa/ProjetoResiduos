...
(function($) {
  ...
  $.fn.raptorize = function(options) {
    ...
    return this.each(function() {
		...
		var raptorImageMarkup = '<img id="elRaptor" style="display: none" src="raptorize/images/raptor.png" />'
		var raptorAudioMarkup = '<audio id="elRaptorShriek" preload="auto"><source src="raptorize/sounds/raptor-sound.mp3" /><source src="sounds/raptor-sound.ogg" /></audio>';	
		var locked = false;
